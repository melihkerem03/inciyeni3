          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-4 text-white/80">
              <li className="flex items-start gap-3">
                ...
                <span>Atakent, Yavuzlar Plaza, Mithatpaşa Cd. no:72 D:4, 34400 Ümraniye/İstanbul</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <Link 
                  href="mailto:info@incidmcturizm.com" 
                  className="hover:text-emerald-400 transition-colors cursor-pointer z-20 relative"
                >
                  info@incidmcturizm.com
                </Link>
              </li>
            </ul>
          </div>
